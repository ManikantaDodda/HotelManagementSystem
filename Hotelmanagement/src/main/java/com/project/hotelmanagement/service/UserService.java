...
public class UserService {
    ...
    public void initRoleAndUser() {
        ...
        hoteladminRole.setRoleName("HotelAdmin");
        hoteladminRole.setRoleDescription("Hotel Admin role");
        roleDao.save(hoteladminRole);
...
//        userDao.save(user);
    ...
    public User registerNewUser(User user) {
        ...
        User uuser=userDao.findByUserName(user.getUserName());
        if(uuser !=null) 
        	throw new IllegalNameException("Username already exists");
